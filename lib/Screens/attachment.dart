...
class _CreateTaskScreenState extends State<CreateTaskScreen> {
  ...
  final TextEditingController _tagController =
      TextEditingController(); // Controller for tag input
  ...
  Future<void> _pickAttachments() async {
    ...
    if (result != null) {
      setState(() {
        // Append new files without removing previously selected ones
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_lang["create_task"] ?? "Create Task",
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                // Task Name
                Text(_lang["task_name"] ?? "Task Name",
                ...
                TextFormField(
                  ...
                  validator: (value) =>
                      value!.isEmpty ? 'Please enter the task name' : null,
                ),
                ...
                // Assigned To
                Text(_lang["assigned_to"] ?? "Assigned To",
                    style: const TextStyle(fontWeight: FontWeight.w500)),
                const SizedBox(height: 8),
                ...
                if (_assignedTo == "Employees") ...[
                  const SizedBox(height: 16),
                  Text(_lang["select_employee"] ?? "Select Employee",
                      style: const TextStyle(fontWeight: FontWeight.w500)),
                  const SizedBox(height: 8),
                  DropdownButtonFormField<String>(
                    decoration: InputDecoration(
                    ...
                    validator: (value) =>
                        _assignedTo == "Employees" && value == null
                            ? 'Please select an employee'
                            : null,
                    hint:
                        Text(_lang["select_employee"] ?? "Select an employee"),
                    items: [],
                  ),
                ],
                ...
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    InkWell(
                      onTap: _pickAttachments, // Function to select files
                      child: Container(
                ...
                // Task Description
                Text(_lang["task_description"] ?? "Task Description",
                    style: const TextStyle(fontWeight: FontWeight.w500)),
                const SizedBox(height: 8),
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: Colors.white,
                    hintText: _lang["enter_task_description"] ??
  ...
  Widget _customRowFields({required String label, required Widget child}) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          const SizedBox(height: 8),
          child, // Accepts any widget (Dropdown, TextField, etc.)
        ],
      ),
    );
  }
